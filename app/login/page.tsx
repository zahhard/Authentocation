    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="mt-64 flex flex-col lg:w-1/2 mx-auto justify-center gap-6 border  border-pink-50 p-14 rounded-2xl "  >
                ...
                <button className="bg-pink-900 text-xl text-white py-2 px-8 w-fit justify-center items-center mx-auto rounded-xl cursor-pointer hover:bg-pink-950 " onClick={handleLogin}>Login</button>
            </div>
        </div>
    );
}
